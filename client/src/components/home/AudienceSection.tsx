  ...
  return (
    <section id="audiences" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Maryland Businesses We Support</h2>
          <p className="text-neutral-600 text-lg">
            Specialized IT support for small businesses, startups, remote workers, and home-based businesses across Maryland. 
            We offer beginner-friendly tech consulting and affordable solutions tailored to each client's needs.
          </p>
        </motion.div>
